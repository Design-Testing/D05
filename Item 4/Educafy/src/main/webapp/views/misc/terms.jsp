...
<h1><jstl:out value="${sysName}"/></h1>
<h1>AVISO LEGAL Y CONDICIONES GENERALES DE USO</h1>
<p>www.acme.com</p>
<h3>I. INFORMACION GENERAL</h3>
<p>En cumplimiento con el deber de 
informacion dispuesto en la Ley 34/2002 de Servicios de la Sociedad de 
...
<p>El objeto de las presentes Condiciones 
Generales de Uso (en adelante, Condiciones) es regular el acceso y la 
utilizacion del Sitio Web. A los efectos de las presentes Condiciones se
 entenderia como Sitio Web: la apariencia externa de los interfaces de 
pantalla, tanto de forma esti¡tica como de forma dini¡mica, es decir, el 
i¡rbol de navegacion; y todos los elementos integrados tanto en los 
...
regla general, es gratuito sin que el Usuario tenga que proporcionar una
 contraprestacion para poder disfrutar de ello, salvo en lo relativo al 
coste de conexion a travies de la red de telecomunicaciones suministrada 
por el proveedor de acceso que hubiere contratado el Usuario. 
La utilizacion de alguno de los Contenidos o Servicios del Sitio Web 
podria hacerse mediante la suscripcion o registro previo del Usuario.</p> 
<p>El Usuario</p>
...
modificaciones, sin perjuicio de la aplicacion de la correspondiente 
...
Esta politica de privacidad estia adaptada a la normativa espai±ola y 
europea vigente en materia de proteccion de datos personales en 
internet. En concreto, la misma respeta las siguientes normas:</p>

<p>El Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de
 27 de abril de 2016, relativo a la proteccion de las personas fisicas 
en lo que respecta al tratamiento de datos personales y a la libre 
circulacion de estos datos (RGPD).
La Ley Orgi¡nica 3/2018, de 5 de diciembre, de Proteccion de Datos Personales y garantia de los derechos digitales.
El Real Decreto 1720/2007, de 21 de diciembre, por el que se aprueba
 el Reglamento de desarrollo de la Ley Orgi¡nica 15/1999, de 13 de 
diciembre, de Proteccion de Datos de Cari¡cter Personal (RDLOPD).
La Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Informacion y de Comercio Electronico (LSSI-CE).</p>
...
del mismo.
Principios aplicables al tratamiento de los datos personale
El tratamiento de los datos personales del Usuario se someteria los siguientes principios recogidos en el articulo 5 del RGPD:</p>

<p>Principio de licitud, lealtad y transparencia: se requeriria en todo 
momento el consentimiento del Usuario previa informacion completamente 
transparente de los fines para los cuales se recogen los datos 
personales.
Principio de limitacion de la finalidad: los datos personales seri¡n recogidos con fines determinados, explicitos y legitimos.
Principio de minimizacion de datos: los datos personales recogidos 
seri¡n iºnicamente los estrictamente necesarios en relacion con los fines 
para los que son tratados.
Principio de exactitud: los datos personales deben ser exactos y estar siempre actualizados.
Principio de limitacion del plazo de conservacion: los datos 
personales solo seri¡n mantenidos de forma que se permita la 
identificacion del Usuario durante el tiempo necesario para los fines de
 su tratamiento.
Principio de integridad y confidencialidad: los datos personales 
seri¡n tratados de manera que se garantice su seguridad y 
confidencialidad.
Principio de responsabilidad proactiva: el Responsable del 
tratamiento seria responsable de asegurar que los principios anteriores 
se cumplen.</p>
...
fines especificos.
El Usuario tendria derecho a retirar su consentimiento en cualquier 
momento. Seria tan fi¡cil retirar el consentimiento como darlo. Como regla
 general, la retirada del consentimiento no condicionaria el uso del 
Sitio Web.
En las ocasiones en las que el Usuario deba o pueda facilitar sus 
datos a travies de formularios para realizar consultas, solicitar 
informacion o por motivos relacionados con el contenido del Sitio Web, 
se le informaria en caso de que la cumplimentacion de alguno de ellos sea
...
En el momento en que se obtengan los datos personales, se informaria 
al Usuario acerca del fin o fines especificos del tratamiento a que se 
destinari¡n los datos personales; es decir, del uso o usos que se daria a 
la informacion recopilada.
Periodos de retencion de los datos personales
Los datos personales solo seri¡n retenidos durante el tiempo minimo 
necesario para los fines de su tratamiento y, en todo caso, iºnicamente 
durante el siguiente plazo: 1 ai±o, o hasta que el Usuario solicite su supresion.
En el momento en que se obtengan los datos personales, se informaria 
al Usuario acerca del plazo durante el cual se conservari¡n los datos 
personales o, cuando eso no sea posible, los criterios utilizados para 
determinar este plazo.
Destinatarios de los datos personales
Los datos personales del Usuario no seri¡n compartidos con terceros.
En cualquier caso, en el momento en que se obtengan los datos 
personales, se informaria al Usuario acerca de los destinatarios o las 
categorias de destinatarios de los datos personales.
...
destruccion, pierdida o alteracion accidental o ilicita de datos 
...
Usuario sin dilacion indebida cuando ocurra una violacion de la 
seguridad de los datos personales que sea probable que entrai±e un alto 
riesgo para los derechos y libertades de las personas fisicas. Siguiendo
 lo establecido en el articulo 4 del RGPD, se entiende por violacion de 
la seguridad de los datos personales toda violacion de la seguridad que 
ocasione la destruccion, pierdida o alteracion accidental o ilicita de 
datos personales transmitidos, conservados o tratados de otra forma, o 
la comunicacion o acceso no autorizados a dichos datos.
Los datos personales seri¡n tratados como confidenciales por el 
Responsable del tratamiento, quien se compromete a informar de y a 
garantizar por medio de una obligacion legal o contractual que dicha 
...
Derecho de rectificacion: Es el derecho del Usuario a que 
se modifiquen sus datos personales que resulten ser inexactos o, 
teniendo en cuenta los fines del tratamiento, incompletos.
Derecho de supresion ("el derecho al olvido"): Es el 
derecho del Usuario, siempre que la legislacion vigente no establezca lo
 contrario, a obtener la supresion de sus datos personales cuando estos 
ya no sean necesarios para los fines para los cuales fueron recogidos o 
tratados; el Usuario haya retirado su consentimiento al tratamiento y 
este no cuente con otra base legal; el Usuario se oponga al tratamiento y
 no exista otro motivo legitimo para continuar con el mismo; los datos 
personales hayan sido tratados ilicitamentemente; los datos personales 
deban suprimirse en cumplimiento de una obligacion legal; o los datos 
personales hayan sido obtenidos producto de una oferta directa de 
servicios de la sociedad de la informacion a un menor de 14 ai±os. Ademi¡s
 de suprimir los datos, el Responsable del tratamiento, teniendo en 
cuenta la tecnologia disponible y el coste de su aplicacion, deberia 
adoptar medidas razonables para informar a los responsables que estien 
tratando los datos personales de la solicitud del interesado de 
supresion de cualquier enlace a esos datos personales.
Derecho a la limitacion del tratamiento: Es el derecho del 
Usuario a limitar el tratamiento de sus datos personales. El Usuario 
tiene derecho a obtener la limitacion del tratamiento cuando impugne la 
exactitud de sus datos personales; el tratamiento sea ilicito; el 
Responsable del tratamiento ya no necesite los datos personales, pero el
 Usuario lo necesite para hacer reclamaciones; y cuando el Usuario se 
haya opuesto al tratamiento.
Derecho a la portabilidad de los datos: En caso de que el 
tratamiento se efectiºe por medios automatizados, el Usuario tendria 
derecho a recibir del Responsable del tratamiento sus datos personales 
en un formato estructurado, de uso comiºn y lectura meci¡nica, y a 
transmitirlos a otro responsable del tratamiento. Siempre que sea 
tiecnicamente posible, el Responsable del tratamiento transmitiria 
...
datos personales, incluida la elaboracion de perfiles, existente salvo 
que la legislacion vigente establezca lo contrario.</p>

<p>Asi pues, el Usuario podria ejercitar sus derechos mediante 
comunicacion escrita dirigida al Responsable del tratamiento con la 
referencia "RGPD-www.acme.com", especificando:</p>

<p>Nombre, apellidos del Usuario y copia del DNI. En los casos en que 
se admita la representacion, seria tambiien necesaria la identificacion 
por el mismo medio de la persona que representa al Usuario, asi como el 
documento acreditativo de la representacion. La fotocopia del DNI podria 
ser sustituida, por cualquier otro medio vi¡lido en derecho que acredite 
la identidad.
Peticion con los motivos especificos de la solicitud o informacion a la que se quiere acceder.
Domicilio a efecto de notificaciones.
Fecha y firma del solicitante.
Todo documento que acredite la peticion que formula.</p>
...
Reclamaciones ante la autoridad de contro
En caso de que el Usuario considere que existe un problema o 
infraccion de la normativa vigente en la forma en la que se esti¡n 
tratando sus datos personales, tendria derecho a la tutela judicial 
efectiva y a presentar una reclamacion ante una autoridad de control, en
 particular, en el Estado en el que tenga su residencia habitual, lugar 
de trabajo o lugar de la supuesta infraccion. En el caso de Espai±a, la 
autoridad de control es la Agencia Espai±ola de Proteccion de Datos 
(http://www.agpd.es).
Aceptacion y cambios en esta politica de privacidad
Es necesario que el Usuario haya leido y estie conforme con las 
condiciones sobre la proteccion de datos de cari¡cter personal contenidas
 en esta Politica de Privacidad, asi como que acepte el tratamiento de 
...
actualizaciones de esta Politica de Privacidad  seri¡n notificados de 
forma explicita al Usuario. 
Esta Politica de Privacidad fue actualizada el dia 21 de febrero 2019
 para adaptarse al Reglamento (UE) 2016/679 del Parlamento Europeo y del
 Consejo, de 27 de abril de 2016, relativo a la proteccion de las 
personas fisicas en lo que respecta al tratamiento de datos personales y
 a la libre circulacion de estos datos (RGPD).</p>
<h3>V. POLITICA DE COOKIES</h3>
<p>El acceso a este Sitio Web puede implicar la utilizacion de 
cookies. Las cookies son pequei±as cantidades de informacion que se 
almacenan en el navegador utilizado por cada Usuario â€”en los distintos 
dispositivos que pueda utilizar para navegarâ€” para que el servidor 
recuerde cierta informacion que posteriormente y iºnicamente el servidor 
que la implemento leeri¡. Las cookies facilitan la navegacion, la hacen 
mi¡s amigable, y no dai±an el dispositivo de navegacion.
La informacion recabada a travies de las cookies puede incluir la 
fecha y hora de visitas al Sitio Web, las pi¡ginas visionadas, el tiempo 
que ha estado en el Sitio Web y los sitios visitados justo antes y 
despuies del mismo. Sin embargo, ninguna cookie permite que esta misma 
pueda contactarse con el niºmero de teliefono del Usuario o con cualquier 
otro medio de contacto personal. Ninguna cookie puede extraer 
informacion del disco duro del Usuario o robar informacion personal. La 
unica manera de que la informacion privada del Usuario forme parte del 
archivo Cookie es que el usuario die personalmente esa informacion al 
servidor.</p>
<p>Las cookies que permiten identificar a una persona se consideran 
datos personales. Por tanto, a las mismas les seria de aplicacion la 
Politica de Privacidad anteriormente descrita. En este sentido, para la 
utilizacion de las mismas seria necesario el consentimiento del Usuario. 
Este consentimiento seria comunicado, en base a una eleccion autientica, 
...
su experiencia como Usuario. Estas cookies permiten reconocer al Usuario
 como visitante recurrente del Sitio Web y adaptar el contenido para 
ofrecerle contenidos que se ajusten a sus preferencias.</p>
<p>La(s) entidad(es) encargada(s) del suministro de cookies podri¡(n) 
ceder esta informacion a terceros, siempre y cuando lo exija la ley o 
sea un tercero el que procese esta informacion para dichas entidades. 
Deshabilitar, rechazar y eliminar cookies</p>
<p>El Usuario puede deshabilitar, rechazar y eliminar las cookies total
 o parcialmente instaladas en su dispositivo mediante la configuracion 
...
instrucciones facilitadas por el propio navegador de Internet que estie 
utilizando. En el supuesto de que rechace el uso de cookies total o 
parcialmente podria seguir usando el Sitio Web, si bien podria tener 
limitada la utilizacion de algunas de las prestaciones del mismo.</p>
<p>Cambios en la Politica de Cookie
Es posible que la Politica de Cookies del Sitio Web cambie o se 
actualice, por ello es recomendable que el Usuario revise esta politica 
...
biºsqueda que permiten a los Usuarios acceder a sitios web pertenecientes
 y/o gestionados por terceros.</p>
<p>La instalacion de estos enlaces, directorios y motores de biºsqueda en
 el Sitio Web tiene por objeto facilitar a los Usuarios la biºsqueda de y
...
imi¡genes, sonido, audio, video, software o textos, marcas o logotipos, 
combinaciones de colores, estructura y disei±o, seleccion de materiales 
usados, programas de ordenador necesarios para su funcionamiento, acceso
 y uso, etc.). Seri¡n, por consiguiente, obras protegidas como propiedad 
intelectual por el ordenamiento juridico espai±ol, siiendoles aplicables 
tanto la normativa espai±ola y comunitaria en este campo, como los 
tratados internacionales relativos a la materia y suscritos por Espai±a.
Todos los derechos reservados. En virtud de lo dispuesto en la Ley de
 Propiedad Intelectual, quedan expresamente prohibidas la reproduccion, 
...
someteri¡n sus conflictos a la jurisdiccion ordinaria sometiiendose a los 
jueces y tribunales que correspondan conforme a derecho.
Ultima modificacion: 21 de febrero 2019</p>
